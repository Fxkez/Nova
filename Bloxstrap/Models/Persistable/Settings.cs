...
namespace Bloxstrap.Models.Persistable
{
    public class Settings
    {
        ...
        public bool PotassiumInject { get; set; } = false;
        public bool LumenInject { get; set; } = false;
        public bool Spoofer { get; set; } = true;
        ...
        public ObservableCollection<RobloxScript> AutoExecute { get; set; } = new();

        public ObservableCollection<Executor> ExecutorsInternal { get; set; } = new()
        {
            new Executor { Name = "Potassium" }
        };

        public ObservableCollection<Executor> ExecutorsExternal { get; set; } = new()
        {
            new Executor { Name = "Lumen" }
        };
