...
namespace Bloxstrap.UI.ViewModels.Settings
{
    public class BehaviourViewModel : NotifyPropertyChangedViewModel, INavigationAware
    {
        ...
        public bool Spoofer
        {
            get => App.Settings.Prop.Spoofer;
            set => App.Settings.Prop.Spoofer = value;
        }
        ...
        public bool CleanerNova
        {
            get => CleanerItems.Contains("NovaLogs");
            set
            {
                if (value)
                    CleanerItems.Add("NovaLogs");
                else
                    CleanerItems.Remove("NovaLogs");
            }
        }
    }
}
